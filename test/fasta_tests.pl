...
my @reads_params = (
   {
    ...
    file_path_list => [ '/kb/module/data/short_1.fasta' ],
   ...
   },
   {
    ...
    file_path_list => [ '/kb/module/data/short_1.fasta', '/kb/module/data/short_2.fasta' ],
    workspace => $target_workspace,
