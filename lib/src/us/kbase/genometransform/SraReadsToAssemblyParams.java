...
/**
 * <p>Original spec-file type: sra_reads_to_assembly_params</p>
 * 
 * 
 */
...
public class SraReadsToAssemblyParams {
    ...
    public SraReadsToAssemblyParams withReadsShockRef(java.lang.String readsShockRef) {
        this.readsShockRef = readsShockRef;
        return this;
    }
    ...
    public SraReadsToAssemblyParams withReadsHandleRef(java.lang.String readsHandleRef) {
        this.readsHandleRef = readsHandleRef;
        return this;
    }
    ...
    public SraReadsToAssemblyParams withReadsType(java.lang.String readsType) {
        this.readsType = readsType;
        return this;
    }
    ...
    public SraReadsToAssemblyParams withFilePathList(List<String> filePathList) {
        this.filePathList = filePathList;
        return this;
    }
    ...
    public SraReadsToAssemblyParams withWorkspace(java.lang.String workspace) {
        this.workspace = workspace;
        return this;
    }
    ...
    public SraReadsToAssemblyParams withReadsId(java.lang.String readsId) {
        this.readsId = readsId;
        return this;
    }
    ...
    public SraReadsToAssemblyParams withOutward(java.lang.String outward) {
        this.outward = outward;
        return this;
    }
    ...
    public SraReadsToAssemblyParams withInsertSize(Double insertSize) {
        this.insertSize = insertSize;
        return this;
    }
    ...
    public SraReadsToAssemblyParams withStdDev(Double stdDev) {
        this.stdDev = stdDev;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((((((((("SraReadsToAssemblyParams"+" [readsShockRef=")+ readsShockRef)+", readsHandleRef=")+ readsHandleRef)+", readsType=")+ readsType)+", filePathList=")+ filePathList)+", workspace=")+ workspace)+", readsId=")+ readsId)+", outward=")+ outward)+", insertSize=")+ insertSize)+", stdDev=")+ stdDev)+", additionalProperties=")+ additionalProperties)+"]");
    }
